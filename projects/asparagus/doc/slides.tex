        ...
        \begin{textblock*}{8.0cm}
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[blue, thick] (x, 1.3*x^1.1+0.6);
                    \node at (axis cs: 1.925,3) [blue, align=left] {saved\\ system\\ cost};

                    \addplot[bokugreen, thick] (x, -2*x^0.8+4);
                    \node at (axis cs: 2.0,1) [bokugreen, align=left]{harm \\(from RET\\ externality)};
                \end{axis}
            \end{tikzpicture}
        \end{textblock*}
    \end{frame}
