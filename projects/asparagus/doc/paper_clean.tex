...
%    -> Wind und PV die einzigen Technologien mit großem Potential
%    -> Wind hat soziale Akzeptanzprobleme (bzw. negative welfare impacts)
%    -> Wind kann aber möglicherweise auch positive Effekte auf die Systemkosten haben
%    -> Keine Windkraft auszubauen und damit die Landschaft zu schützen hat also Opportunitätskosten
%    -> Wie hoch sind diese Opportunitätskosten?
%    -> Das ist interessant, weil man damit auch ausrechnen kann, wieviel man im Prinzip kompensieren könnte.
%    Fertig.
...
% ***** Data *****
    ...
    \todo[inline]{investigate why this happens}
    \todo[inline]{add brief explanation for why opportunity cost increase -- more thermal dispatch \& capacity etc.}
    ...
    \todo[inline]{write about impact of cost assumptions on total system cost}
    ...
    \todo[inline]{do we know if there is a co2-price at which fossil backup vanishes? -> at 120 eur / t fossil backup is about halved.}
