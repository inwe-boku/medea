...
parameters
         ...
         OM_VAR_COST(r,tec)              variable O&M cost including transportation
...
equations
         ...
         policy_emlim                    upper limit on GHG emissions in Germany
;
...
obj_omcost(r,tec)..              cost_om(r,tec)
                                 ...
                                 + sum((t,prd), OM_VAR_COST(r,tec) * q_gen(r,t,tec,prd))
                                 ;
