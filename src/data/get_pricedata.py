...
fuel_price_file = os.path.join(cfg.MEDEA_ROOT_DIR, 'data', 'processed', 'monthly_fuel_prices.csv')
...
co2_price_file = os.path.join(cfg.MEDEA_ROOT_DIR, 'data', 'processed', 'co2_price.csv')
