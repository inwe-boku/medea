...
\ctable[
	...
	\makecell[l]{storages \\(power)} & $\widetilde{S}_{z,k}$ & $\widetilde{s}^{+}_{z,k}$ & $\widetilde{s}^{-}_{z,k}$ & $C^{s}_{z,k}$ & $s_{z,t,k}$ \ML
	\makecell[l]{storages \\(energy)} & $\widetilde{V}_{z,k}$ & $\widetilde{v}^{+}_{z,k}$ & $\widetilde{v}^{-}_{z,t,k}$ & $C^{v}_{z,k}$ & na \ML
